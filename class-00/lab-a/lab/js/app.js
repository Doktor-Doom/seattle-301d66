...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `vaar to `let`.
  // PUT YOUR RESPONSE IN THIS COMMENT
  // Console.log(rando); was not called back inside the while loop.
  console.log(viewed);
